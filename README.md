...
- 📔 **내 기록** — 하루 한 장 개인 저널(완전 비공개, 관리자도 못 봄). 아이디어·개발 지식 캡처 → Claude가 검색해 적재적소 활용
...
Claude가 DevFlow의 **실제 데이터**로 일합니다 — 태스크 조회·생성, 상태 변경, 담당자 배정, 문서 등록·분해, 일정 생성·조회, 가이드 작성, 지식 검색, 내 기록 캡처·검색 (도구 18종).
